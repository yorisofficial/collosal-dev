...
export const PRICELIST = [
    {
        ...
        "service": [
            {
                "list1": "10 design pages",
                "list2": "Well-documented",
                "list3": "4 revisions",
                "list4": "$100/additional page"
            }
        ]
    },
    {
    ...
    },
    {
        ...
        "service": [
            {
                "list1": "Daily backup",
                "list2": "3 hourse of maintenance",
                "list3": "Including fixing",
                "list4": "$50/additional hour"
            }
        ]
    }
]
